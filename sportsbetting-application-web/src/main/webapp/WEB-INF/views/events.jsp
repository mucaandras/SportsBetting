    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="nav-link" href=/#"><spring:message code="app.home"/> </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#"><spring:message code="app.events"/><span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="?lang=hu"><spring:message code="app.lang.hungarian"/></a>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table class="table">
                ...
                <tbody>
                    <div align=""
                <c:forEach var="sportevent" items="${sportevents}">
                            ...
                            <c:forEach var="outcomeodd" items="${outcome.outcomeOdds}">
                                <tr>
                                    ...
                                    <td class="text-center align-middle">${outcomeodd.value}</td>
                                        ...
                                        <td class="text-center align-middle"> <button type="submit" class="btn btn-outline-success my-2 my-sm-0"><spring:message code="app.addwager"/></button></td>
